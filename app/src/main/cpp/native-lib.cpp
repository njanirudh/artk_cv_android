...
char vconf[] = "";
const char markerConfigDataFilename[] ;
...
Java_com_example_anirudh_android_1opencv_1template_ImageProcessing_initializeAR(
        JNIEnv * env , jobject /* this */, string cam_para_path, string marker_path) {

    cparam_name = cam_para_path.c_str();
    markerConfigDataFilename = marker_path.c_str();
